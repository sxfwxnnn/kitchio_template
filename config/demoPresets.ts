...
export const demoPresets: Record<string, DemoPreset> = {
  ...
  "2": {
    ...
    logo: "/img/menu/garlic-bread.jpg", // placeholder
    coverImage: "/img/menu/margherita.jpg", // placeholder
    restaurant: {
      id: "a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11",
      slug: "crunchy-chicken",
      name: "Crunchy Fried Chicken",
      logo: "/img/menu/garlic-bread.jpg",
      coverImage: "/img/menu/margherita.jpg",
      primaryColor: "#E11D48",
      cuisine: "Crispy Southern Fried Chicken & Sides",
      rating: 4.7,
      deliveryTime: "20-30",
